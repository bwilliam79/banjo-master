...
- **caddy** — reverse proxy published on host **8443** (container 443, self-signed). Not on host :443 (reserved for house HTTPS edge / UniFi WAN 443). LAN: `https://media-server:8443`
